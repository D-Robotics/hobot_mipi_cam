...
# HSMT sc233hgs 4 cameras (VC0~VC3) on one deserializer, mipi_rx 0.
# Deserializer is managed by libsc233hgs_hsmt.so, no deserial node in vflow.
...
def generate_launch_description():
    ...
    mipi_gsml_cfg_file_arg = DeclareLaunchArgument(
        ...
        default_value=[
            ...
            "hsmt_sc233hgs_1deserial_4vc_config.json"
        ],
    ...
    # 首次链路验证：输出与 sensor 同分辨率(1920x1200)、不旋转，PYM 变量最少
    ...
    mipi_frame_ts_type_arg = DeclareLaunchArgument(
        ...
        description='mipi camera out image timestamp type')
    ...
    # nv12->jpeg（multi 模式下 mipi_cam 发布 /image_combine_raw，4 帧竖拼）
