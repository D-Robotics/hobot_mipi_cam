...
static deserial_config_t gsml_deserial_config = {
    .name = "max96712",
    .link_desp[0] = "sc132gs:0@33024",
    .link_desp[1] = "sc132gs:0@33024",
    .link_desp[2] = "sc132gs:0@33024",
    .link_desp[3] = "sc132gs:0@33024",
    .gpio_mfp[CAMERA_DES_GPIO_TRIG0] = 0x6,
    .gpio_mfp[CAMERA_DES_GPIO_TRIG1] = 0x6,
    .gpio_mfp[CAMERA_DES_GPIO_TRIG2] = 0x6,
    .gpio_mfp[CAMERA_DES_GPIO_TRIG3] = 0x6,
    .addr = 0x29,
    .poc_cfg = &g_poc_cfg[0],
